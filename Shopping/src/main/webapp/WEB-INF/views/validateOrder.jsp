					...
					<h3>Order Details</h3>
                        ...
                        <div class="row margin-left25" ng-controller = "cartCtrl" ng-init="initCartId('${cartId}')">
                                ...
                                <c:forEach var="cartItem" items="${order.cart.cartItems}" >
                                    <tr>
                                    <td class="col-md-3"><img src="<c:url value="/resources/images/${cartItem.item.itemId}.png" /> " style="height:200px;width:200px" alt="image"/></td>
                                        <td class="col-md-5"><em>${cartItem.item.itemName}</em></td>
